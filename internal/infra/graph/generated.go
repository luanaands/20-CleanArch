...
import (
	...
	"github.com/luanaands/clean-arch/internal/infra/graph/model"
...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalOOrderInput2ᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOOrder2ᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder,
		true,
		false,
	)
}
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNOrder2ᚕᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNOrder2ᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Order(ctx, sel, v)
...
func (ec *executionContext) unmarshalOOrderInput2ᚖgithubᚗcomᚋluanaandsᚋcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v any) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
