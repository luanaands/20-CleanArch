...
func (x *GetOrderResponse) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *GetOrderResponse) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
func (x *OrderList) GetOrders() []*GetOrderResponse {
	if x != nil {
		return x.Orders
	}
	return nil
...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"finalPrice\"9\n" +
	"\tOrderList\x12,\n" +
	"\x06orders\x18\x01 \x03(\v2\x14.pb.GetOrderResponseR\x06orders2|\n" +
	"\fOrderService\x12@\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\"\x00\x12*\n" +
	"\fGetAllOrders\x12\t.pb.blank\x1a\r.pb.OrderList\"\x00B\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	3, // 0: pb.OrderList.orders:type_name -> pb.GetOrderResponse
	...
	4, // 4: pb.OrderService.GetAllOrders:output_type -> pb.OrderList
